/**
 * Claude provider quota fetch + parse helper. Returns usage windows,
 * extra-usage info, and the resolved plan type i18n key.
 */
...
import { formatQuotaResetTime, createStatusError } from '../formatters';
import {
  normalizeAuthIndex,
